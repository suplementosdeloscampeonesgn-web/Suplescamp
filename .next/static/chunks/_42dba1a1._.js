...
"[project]/src/app/contacto/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function Contacto() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setTimeout(()=>{
            const whatsappMessage = "🔥 NUEVA CONSULTA - Suplementos GN 🔥%0A%0A👤 *Nombre:* ".concat(formData.name, "%0A📧 *Email:* ").concat(formData.email, "%0A📱 *Teléfono:* ").concat(formData.phone, "%0A📋 *Asunto:* ").concat(formData.subject, "%0A%0A💬 *Mensaje:*%0A").concat(formData.message, "%0A%0A_Enviado desde la web de Suplementos De Los Campeones GN_");
            window.open("https://wa.me/524443166595?text=".concat(whatsappMessage), '_blank');
...
_s(Contacto, "LDLaEbRumUzOIChFccUKZv8xXqg=");
_c = Contacto;
var _c;
...
//# sourceMappingURL=_42dba1a1._.js.map